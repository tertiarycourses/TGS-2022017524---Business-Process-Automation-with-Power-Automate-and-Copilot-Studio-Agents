...
> **⚠️ Warning:** Your agent (Copilot Studio) and your flow (Power Automate) must live in the **same environment — Course Sandbox**. If they are in different environments, the agent will not be able to find or call its flow. Before you begin, open both [Copilot Studio](https://copilotstudio.microsoft.com) and [Power Automate](https://make.powerautomate.com) and confirm the **top-right environment picker** shows **Course Sandbox** in each.
