...
## Prerequisites
- Completed [Lab 1](../Lab%201%20-%20Instant%20Email%20Flow/index.md) (Send an email) and [Lab 2](../Lab%202%20-%20Instant%20Excel%20Logging%20Flow/index.md) (Excel table + logging)
...
![Lab 4 automated Microsoft Forms workflow flowchart](assets/flowchart.png)
...
Download
[Lab4-Automated-Form-to-Email-and-Excel.zip](Lab4-Automated-Form-to-Email-and-Excel.zip),
then use **My flows → Import → Import Package (Legacy)**. Map Forms, Outlook
and Excel connections and follow the
[import details](#part-2--import-the-packaged-flow). Select your
...
> **⚠️ Warning:** If you get an **Unauthorized** error, the Outlook connection is broken or the account has no mailbox. Reconnect **Office 365 Outlook** with a mailbox-enabled account (see [Lab 1](../Lab%201%20-%20Instant%20Email%20Flow/index.md)); the connection must show a green ✓.
...
| Date shows literal text | Enter the date through the **fx** editor so it becomes a token (see [Lab 2](../Lab%202%20-%20Instant%20Excel%20Logging%20Flow/index.md)). |
...
## Next Steps
You have completed the first event-driven flow. Proceed to [Lab 5: Human Approval Flow](../Lab%205%20-%20Human%20Approval%20Flow/index.md) to add a person and a business decision inside an automation.
